...
public class Second implements Product {
	...
	public int buyProduct(int p_num) {
		...
		System.out.println("1612년(영양왕 23년) 중국 수(隋)나라의 군대를 고구려의 을지문덕 장군이 살수(薩水)에서 크게 격파한 싸움.");
		...
		if (nowprice == 2000) {
			...
			System.out.println("살수대첩 사건의 경매를 끝내겠습니다.");
			System.out.println("==================================================================\n");
			price = nowprice;
			return m_num;
